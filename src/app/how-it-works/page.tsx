      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Getting started on THE CA Connect is simple. Follow these steps to connect with opportunities and grow your professional network.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Join thousands of Chartered Accountants and professionals already using THE CA Connect to grow their network.
          </p>
